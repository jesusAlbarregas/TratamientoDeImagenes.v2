...
<html lang="es">
    ...
    <body>
        <div id="principal">
            <h1>Actualizar usuario mediante la clase Part</h1>
            <form name="myform" action="${contexto}/SubirAvatarUsuarioPart" method="post" enctype="multipart/form-data">   
                ...
                <fieldset class="index">
                    ...
                    <p>
                    <img src='<c:url value="/imagenes/avatares/${sessionScope.usuario.avatarPart}"/>' 
                    ...
                    <input id="av" type="file" name="avatarPart" class="form-control">
                    </p>
                </fieldset>
                <br/>
